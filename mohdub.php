...
##@php_apa###
##@KTTXT###
$API_KEY = "5569285571:AAHtuVvrDnGmkkoVq9Papv9dbxGVEaJl65A"; // التوكن البوت
$Dev = array("5425648566", "5425648566" ); //ايدي المطور 
flush();
ob_start();
set_time_limit(0);
error_reporting(0);
...
function bot($method,$datas=[]){
    $V_ip00 = http_build_query($datas);
        $url = "https://api.telegram.org/bot".API_KEY."/".$method."?$V_ip00";
        $V_ip00_Sy = file_get_contents($url);
        return json_decode($V_ip00_Sy);
}
